...
> **v2.0.0** — Skills **Import folder** full-page UX restored; OpenAI-compat / GLM `1210` translation hardening for long sessions. See [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v2.0.0).
