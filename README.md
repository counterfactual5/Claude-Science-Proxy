...
> **公开预览（early preview）**：源码与 Release 以 `v0.1.0-public-preview` 为首次公开标记；桌面 app 构建线约为 **0.3.x**，配置格式与行为可能变更。问题与建议请走 [GitHub Issues](https://github.com/counterfactual5/Claude-Science-Proxy/issues)。公开前自检见 [`docs/PUBLIC_RELEASE_CHECKLIST.md`](./docs/PUBLIC_RELEASE_CHECKLIST.md)。
