...
> **v1.2.0** — adds a local Skill Manager and local stdio MCP manager (with discover-and-import). Report issues on [GitHub](https://github.com/counterfactual5/Claude-Science-Proxy/issues).
