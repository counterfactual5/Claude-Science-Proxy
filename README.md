...
> **v1.6.5** — GENERAL search: free DuckDuckGo Lite + Wikipedia fallback; clarify `csp_web_search` ≡ `web_search`; stop “must configure API key” when Instant Answer is empty. Local build; no GitHub release.
