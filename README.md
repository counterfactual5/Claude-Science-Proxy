...
> **v1.6.6** — GENERAL search: single public MCP method `csp_web_search` (`tools/list`); `web_search` kept as unlisted dispatch alias. Native Anthropic `web_search` still never call. Local build; no GitHub release.
