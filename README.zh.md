...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.2.0-brightgreen.svg" alt="v1.2.0">
...
> **v1.2.0** 新增本地 Skill 管理器与本地 stdio MCP 管理器（支持发现并导入）。问题与建议请走 [GitHub Issues](https://github.com/counterfactual5/Claude-Science-Proxy/issues)。
