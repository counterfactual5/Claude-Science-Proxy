...
> **公开预览（early preview）**：源码与 Release 以 `v1.0.0` 为首次公开标记；桌面 app 构建线约为 **1.0.x**，配置格式与行为可能变更。问题与建议请走 [GitHub Issues](https://github.com/counterfactual5/Claude-Science-Proxy/issues)。
...
已知问题和故障请前往 GitHub Issues 进行反馈。

## 参与贡献

欢迎 issue 与 PR。开始前请读 [`AGENT.md`](./AGENT.md) 与 [`docs/DEVELOPMENT.md`](./docs/DEVELOPMENT.md)，并跑 `bash test/run_all.sh`。
