...
> **v1.6.13** — Skills「打开文件夹」仅保留在各卡片 `⋯`（`open_skill_folder`）；去掉顶栏打开整个 skills 根目录及未使用的 `open_skills_root`。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.6.13)。
