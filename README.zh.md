...
> **v2.1.0** — 出网待批准审批与常见域名预授权；Fake-IP 出网状态灯；Skill 扫描导入搜索与更多扫描根；Science rolling-compact 工具列表剥离。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v2.1.0) · [更新日志](./CHANGELOG.md)。
