...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.6.5-brightgreen.svg" alt="v1.6.5">
...
> **v1.6.5** — 通用搜索：免密钥 DuckDuckGo Lite + 维基回退；明确 `csp_web_search` ≡ `web_search`；Instant Answer 为空时不再误导「必须配置 API key」。本地构建，暂不发 Release。
