...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.6.10-brightgreen.svg" alt="v1.6.10">
...
> **v1.6.10** — 运行状态行；Skill/MCP 整页表单；更多 Provider 预设；`search_skills` 引导；GLM/OpenAI 连接保活与带日期 shell 路由。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.6.10)。
