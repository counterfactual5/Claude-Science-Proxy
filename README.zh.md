...
> **v1.6.12** — Skills/MCP 元信息：路径行 + 标签行（去掉孤立 ·）；行内 ⋯ 菜单 z-index/overflow 修复；Skills 顶栏「打开文件夹」收入 `⋯`（`open_skills_root`）。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.6.12)。
