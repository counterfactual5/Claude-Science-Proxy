...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-2.0.0-brightgreen.svg" alt="v2.0.0">
...
> **v2.0.0** — 扫描本机编辑器/Agent 的自定义 LLM 配置（Zed、OpenClaw/QClaw、Trae/TRAE SOLO、Cursor、Claude Code 等）导入 CSP；拼盘「浏览全部模型」与全目录搜索；模型顺序保持原样；拼盘热重载与 FALLBACK 凭据修复。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v2.0.0) · [更新日志](./CHANGELOG.md)。
