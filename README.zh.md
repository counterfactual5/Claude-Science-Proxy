...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.6.9-brightgreen.svg" alt="v1.6.9">
...
> **v1.6.9** — 内置本地 **web-search**（GENERAL `csp_web_search` + LITERATURE `search_literature`）、代理 standing 引导、**`csp-environment`** Skill、网络授权，以及打开 App 时刷新 MCP 脚本。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.6.9)。
