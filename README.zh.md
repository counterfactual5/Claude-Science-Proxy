...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.6.14-brightgreen.svg" alt="v1.6.14">
...
> **v1.6.14** — Science 运行中新建/导入/启停 Skill 或 MCP 会重新部署并自动重启；MCP 界面补齐 i18n；`SERVER_VERSION` 对齐。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.6.14)。
