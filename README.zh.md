...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.6.11-brightgreen.svg" alt="v1.6.11">
...
> **v1.6.11** — 统一 Skills/MCP「+ 新建」入口；Skill 对齐 MCP「扫描导入」（路径导入收进高级）；标签换行与检查预览 `[hidden]` 修复。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.6.11)。
