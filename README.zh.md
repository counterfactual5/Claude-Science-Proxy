...
> **v1.9.0** — 多提供商 · 自选模型（最多 8 个，跨已保存提供商）；含 v1.8.2 Science 技能库同步。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.9.0) · [更新日志](./CHANGELOG.md)。
