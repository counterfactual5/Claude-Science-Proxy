...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.6.7-brightgreen.svg" alt="v1.6.7">
...
> **v1.6.7** — GENERAL auto 止于 DDG IA/lite（Wikipedia 仅留在 LITERATURE 的 `search_literature`）。本地构建，暂不发 Release。
