...
> **v1.6.3** — `web-search` 拆成两条链路：通用 (`web_search`/`csp_web_search`：Brave/Serper/Tavily → duckduckgo_ia) 与学术 (`search_literature`：wikipedia → Crossref/arXiv/PubMed)。本地构建，暂不发 Release。
