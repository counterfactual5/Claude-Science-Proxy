...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.6.8-brightgreen.svg" alt="v1.6.8">
...
> **v1.6.8** — 加固 DuckDuckGo Lite anti-bot（cookie 预热 / 重试）；禁止 GENERAL「回退 Wikipedia / 必须配 API key」的错误叙述。本地构建，暂不发 Release。
