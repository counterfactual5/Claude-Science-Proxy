...
> **v1.8.2** — 同步 Science 技能库（回收 Edit/对话改动到 `~/.csp/skills/`）；含 v1.8.1 Skills 导入（目录/zip/URL）、MCP 远程 + 扫描预览、扩展扫描根。详见 [Releases](https://github.com/counterfactual5/Claude-Science-Proxy/releases/tag/v1.8.2) · [更新日志](./CHANGELOG.md)。
