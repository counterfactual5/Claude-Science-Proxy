...
> **v1.3.0** 将 Skill/MCP 扫描导入扩展到常见国产工具，新增 MCP `JSON` 快捷编辑，并修复沙盒内 Node MCP 连接器（如 Notion）访问 HTTPS API 的问题。问题与建议请走 [GitHub Issues](https://github.com/counterfactual5/Claude-Science-Proxy/issues)。
