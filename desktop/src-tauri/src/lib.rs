...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::skills::pick_skill_source,
            ...
            commands::skills::discover_science_skill_sync,
            commands::skills::preview_workspace_skill,
            commands::skills::preview_science_skill,
            commands::skills::open_workspace_skill,
            commands::skills::open_science_skill,
            commands::skills::adopt_workspace_skills,
            commands::skills::sync_science_skills,
            ...
            commands::mcp::list_network_pending,
            commands::mcp::approve_network_domains,
            commands::mcp::dismiss_network_pending,
            commands::mcp::discover_mcp_servers,
            commands::mcp::preview_discovered_mcp,
            commands::mcp::open_discovered_mcp_source,
