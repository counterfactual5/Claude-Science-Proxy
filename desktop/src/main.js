...
const mockStore = { 
  ...
  mcpServers: [
    { id: "mcp_0000000000000000", name: "web-search", description: "Local web + literature search (no API key required). GENERAL csp_web_search → duckduckgo_ia/lite/wikipedia; LITERATURE search_literature → Crossref/arXiv/PubMed. Optional BRAVE_SEARCH_API_KEY / SERPER_API_KEY / TAVILY_API_KEY improve reliability only. Never call native Anthropic web_search.", command: "python3", args: ["/Users/me/.csp/sandbox/home/.claude-science/mcp/csp-web-search-server.py"], env: { BRAVE_SEARCH_API_KEY: "", SERPER_API_KEY: "", TAVILY_API_KEY: "" }, enabled: true, builtin: true, createdAt: "2026-07-12T02:30:00Z", updatedAt: "2026-07-12T02:30:00Z" },
