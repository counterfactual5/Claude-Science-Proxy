...
const I18N = {
  cn: {
    ...
    errOauthOrphanOrgs: "检测到 {count} 个历史组织，但 active-org.json 缺失且无可解令牌，无法确定当前活动组织；为避免旧对话被孤儿化已中止。可用组织：{org_list}。请把想要的 org_uuid 写回 {active_org_path} 后重试。",
  ...
  intl: {
    ...
    errOauthOrphanOrgs: "Found {count} historical orgs but active-org.json is missing and no decryptable token exists; cannot determine the active org. Aborted to avoid orphaning old conversations. Available orgs: {org_list}. Write the desired org_uuid to {active_org_path} and retry.",
