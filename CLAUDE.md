...
- **发布态**：v0.1.2 已公开（github.com/SuperJJ007/CSswitch）；桌面 app 在 `desktop/`（Tauri 菜单栏进程管家）。当前待修 3 个 bug → `docs/known-issues.md`。
...
desktop/                          Tauri 菜单栏 app（构建见 desktop/README.md）
