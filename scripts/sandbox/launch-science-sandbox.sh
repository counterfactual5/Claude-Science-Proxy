...
#
# Usage:
#   scripts/sandbox/launch-science-sandbox.sh [--port 8990] [--proxy-url http://127.0.0.1:18991]
#   Start the proxy in another terminal first: CSP_RELAY_KEY=... python3 proxy/core/csp_proxy.py --provider relay --port 18991
set -euo pipefail
...
echo "停止: scripts/sandbox/stop-science-sandbox.sh"
